                ...
                <div class="col-sm-12" style="margin-top: 30px">
                    <div class="card">
                        ...
                        <div class="card-body add-slider">
                            <form class="row" method="POST" action="{{ route('admin.home.sliders.update', $slider) }}"
                                ...
                                <div class="row mb-5">
                                    <div class="col-sm-6">
                                        ...
                                        <textarea name="title"
                                                  ...
                                                  rows="5">{{ old('title', $slider->title) }}</textarea>
                                        @error('title')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <textarea name="sub_title"
                                                  ...
                                                  rows="5">{{ old('sub_title', $slider->sub_title) }}</textarea>
                                        @error('sub_title')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
