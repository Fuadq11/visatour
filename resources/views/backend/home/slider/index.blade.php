        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a style="float: right" href="{{ route('admin.home.sliders.create') }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display datatables" id="slider">
                                    <thead>
                                    <tr>
                                        <th>{{ __('row') }}</th>
                                        <th>{{ __('image') }}</th>
                                    ...
                                    @foreach ($sliders as $slider)
                                        <tr>
                                            ...
                                            <td><img style="width: 100px; height: 90px;" src="{{ asset($slider->image) }}" alt="img"></td>
                                            <td>{!! $slider->title !!}</td>
                                            <td>
                                                <a href="{{ route('admin.home.sliders.edit', $slider) }}"
                                                   class="btn btn-primary btn-xs edit" type="button"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="{{ route('admin.home.sliders.destroy', $slider) }}"
