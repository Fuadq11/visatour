                    ...
                    <div class="card">
                        ...
                        <div class="card-body add-visa_options">
                            <form class="row" method="POST"
                                  action="{{ route('admin.service.countries.visa.options.update', [$country, $visa,$visaOption]) }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="fee_types[]" class="form-control"
                                            ...
                                            @foreach ($feeTypes as $feeType)
                                                <option
                                                    {{ $feeType->id == in_array($feeType->id,$visaOption->fee_types()->pluck('id')->toArray())? 'selected': '' }}
                                                    value="{{ $feeType->id }}">{{ $feeType->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('fee_types')
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        <select id="visa_type" class="form-select" name="visa_type_id" required
                                            ...
                                            @foreach ($visaTypes as $visaType)
                                                <option @if($visaType->id === $visaOption->visa_type_id) selected
                                                        @endif value="{{ $visaType->id }}">{{ $visaType->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('visa_type_id')
                                        <span class="text-danger" role="alert">
                                    ...
                                    <div class="col-sm-3 mb-3">
                                        ...
                                        name="name" value="{{ old('name', $visaOption->name) }}" required>
                                        @error('name')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-sm-2 mb-3">
                                        ...
                                        <input type="number" class="form-control" @error('order_no') is-invalid
                                               @enderror
                                               name="order_no" value="{{ old('order_no', $visaOption->order_no) }}"
                                               required>
                                        @error('order_no')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="visa_fee"
                                                               value="{{ old('visa_fee', $visaOption->visa_fee) }}"
                                                    ...
                                                    <div class="col-sm-3 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="price"
                                                               value="{{ old('price', $visaOption->price) }}"
                                                    ...
                                                    <div class="col-sm-3 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="visa_period"
                                                               value="{{ old('visa_period', $visaOption->visa_period) }}">
                                                        @error('visa_period')
                                                        <span class="text-danger" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-3 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="stay_duration"
                                                               value="{{ old('stay_duration', $visaOption->stay_duration) }}">
                                                        @error('stay_duration')
                                                        <span class="text-danger" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <!-- new addings    -->
                                                    <div class="col-sm-3 mb-3">
                                                        <label>{{ __('visa_department_fee') }}: *</label>
                                                        <input type="text" class="form-control"
                                                               @error('visa_department_fee') is-invalid @enderror
                                                               name="visa_department_fee"
                                                               value="{{ old('visa_department_fee', $visaOption->visa_department_fee) }}">
                                                        @error('visa_department_fee')
                                                        <span class="text-danger" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                        @enderror
                                                    ...
                                                    <div class="col-sm-3 mb-3">
                                                        <label>{{ __('administration_fee') }}: *</label>
                                                        <input type="text" class="form-control"
                                                               @error('administration_fee') is-invalid @enderror
                                                               name="administration_fee"
                                                               value="{{ old('administration_fee', $visaOption->administration_fee) }}">
                                                    ...
                                                    <div class="col-sm-3 mb-3">
                                                        <label>{{ __('courier_fee') }}: *</label>
                                                        <input type="text" class="form-control"
                                                               @error('courier_fee') is-invalid @enderror
                                                               name="courier_fee"
                                                               value="{{ old('courier_fee', $visaOption->courier_fee) }}">
                                                        @error('courier_fee')
                                                        <span class="text-danger" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="general_info"
                                                               value="{{ old('general_info', $visaOption->general_info) }}">
                                                        @error('general_info')
                                                        <span class="text-danger" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               value="{{ old('additional_note', $visaOption->additional_note) }}"
